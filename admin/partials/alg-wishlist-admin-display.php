...
<div class="wrap">
    ...
    <div class="card" style="max-width: 800px;">
        ...
        <ul>
            <li><strong>Wishlist Button (Algenib)</strong>: Drag this into your Product Loop or Single Product Template.
            </li>
        ...
        <table class="widefat fixed striped" style="margin-top: 10px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Displays the full grid of products in the wishlist. Create a page (e.g., /wishlist) and add this
                        shortcode.</td>
                </tr>
            </tbody>
        </table>
        ...
        <p>To add the Wishlist button to your Doofinder search results, add this snippet to your <strong>Doofinder Layer
                Template</strong> (Product Card):</p>
